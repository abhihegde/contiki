...
#============================= Simulation Params ============================
totSimTime = 1200.0; #secs
numNodes = 4; #nodes, for GRID topology no: of nodes must be perfect square!
maxDimX = 200.0; #Maximum X-size [m]
maxDimY = 200.0; #Maximum Y-size [m]
...
isNodeSpeedType = 2; # 1-Random speeds, 2-Individual speeds
#if isNodeSpeedType = 2, set the node speeds individually here, only applicable for constant speed scenario
nodeSpeedsList = [0,0,0,8];

#Only this flag can be set when isNodeSpeedType = 1, for isNodeSpeedType = 2, below must always be set to 0
isNodeSpeedAccDecc  = 0; #If set, nodes accelerate from minSpeed to maxSpeed and then deaccelerate from maxSpeed to minSpeed at a random rate


minSpeed = 5.0; # Min speed [m/s]
maxSpeed = 25.0; # Max speed [m/s]
timeStep = 0.2; #[s]
...
isNodeMoveDirection = 2; # 1-Both XY directions, 2- Along X direction, 3-Along Y direction
#===============================================================================
